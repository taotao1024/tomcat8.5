...
public final class Bootstrap {
    ...
    private void initClassLoaders() {
        try {
            /**
             * commonLoader 的父类加载器为空，双拼委派机制被打破。
             * 不同Application的使用不同的类加载器，解决Jar版本冲突问题。
             */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            if (command.equals("startd")) {
                 ...
                 * StandardService.startInternal()--> engine.start()容器-->StandardHost-->StandardContext-->StandardWrapper
