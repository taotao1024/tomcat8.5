...
public class Catalina {
    ...
    /**
     * Bootstrap反射执行Catalina的Load方法<p>
     * 功能：<p>
     * 1、解析server.xml文件 <p>
     * 2、初始化server服务器 --> getServer().init(); <p>
     */
    public void load() {
         ...
         * 创建、执行 解析器
         * 解析XML
         * Digester struts-config.xml tomcat将其源码导入到工程中(org.apache.tomcat.util.digester)
         */
